...
from icij_common.pydantic_utils import merge_configs, icij_config, no_enum_values_config
...
class AppConfig:
    ...
    loggers: ClassVar[list[LiteralString]] = Field(_ALL_LOGGERS)
    ...
    model_config: ConfigDict = merge_configs(icij_config(), no_enum_values_config())

    def to_es_client(self, address: str | None = None) -> "ESClient":
        from icij_commozn.es import ESClient
