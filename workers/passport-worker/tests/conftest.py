...
DS_FILE_1 = DatashareFile(
    ...
    value=WorkerFilePath(
        path=Path("not_a_passport.pdf"), location=FileLocation.FILESYSTEM
    ),
    n_pages=2,
)
...
DS_FILE_2 = DatashareFile(
    ...
    value=WorkerFilePath(path=Path("passport.docx"), location=FileLocation.FILESYSTEM),
    n_pages=1,
)
...
DS_FILE_5 = DatashareFile(
    ...
    value=WorkerFilePath(path=Path("passport.pdf"), location=FileLocation.FILESYSTEM),
    n_pages=1,
)
